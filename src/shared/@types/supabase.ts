  ...
  public: {
    ...
    Functions: {
      create_channel_and_link_user: {
        Args: { description?: string; genre_code?: number; name: string }
        Returns: string
      }
      get_feeds_near_view: {
        Args: { offset_count?: number; target_feed_id: string }
        Returns: {
          audio_url: string | null
          author_id: string | null
          author_nickname: string | null
        ...
        SetofOptions: {
          from: "*"
          to: "get_feeds_with_user_and_likes"
          isOneToOne: false
          isSetofReturn: true
        }
      }
      ...
      update_user_genres: {
        Args: { selected_genres: number[]; user_id: string }
        Returns: {
          data: boolean
          error: string
        }[]
